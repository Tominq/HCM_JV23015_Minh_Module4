...
INSERT INTO Products(productCode, productName, productPrice, productAmount, productAmount, productDescription,
                     productStatus)
VALUES ('1234', "productName", "productPrice", "productAmount", "productAmount", "productDescription", "productStatus"),
       ('1234', "productName", "productPrice", "productAmount", "productAmount", "productDescription", "productStatus"),
       ('1234', "productName", "productPrice", "productAmount", "productAmount", "productDescription", "productStatus"),
       ('1234', "productName", "productPrice", "productAmount", "productAmount", "productDescription", "productStatus");
...
BEGIN
    INSERT INTO Products(productCode, productName, productPrice, productAmount, productAmount, productDescription,
                         productStatus)
    VALUES ("1234", "productName", "productPrice", "productAmount", "productAmount", "productDescription",
            "productStatus");
END //
